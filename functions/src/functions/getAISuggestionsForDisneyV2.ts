// https://csm-disney-v2-clone-azure-openai-nextjs.azurewebsites.net/api/getAISuggestionsForDisneyV2?
...
export async function getAISuggestionsForDisneyV2(
  request: HttpRequest,
...
app.http('getAISuggestionsForDisneyV2', {
  methods: ['GET'],
  authLevel: 'anonymous',
  handler: getAISuggestionsForDisneyV2,
});
